            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        ...
                        <form action="boletaactividades.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            ...
                            <br>
                            <label for="fotos_actividades">Ingrese Fotos Boleta Bitacora Actividades (Máximo 10 fotos)</label>
                            <input type="file" name="fotos_actividades[]" id="fotos_actividades" multiple accept="image/*" class="form-control" required>
                            <br>
...
function validateForm() {
    var input = document.getElementById('fotos_actividades');
