            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        ...
                        <form action="boletaperitajevehiculartransportes.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            ...
                            <label for="fotos_peritaje_transportes">Ingrese Fotos Boleta Peritaje Vehicular Transportes (Máximo 10 fotos)</label>
                            <input type="file" name="fotos_peritaje_transportes[]" id="fotos_peritaje_transportes" multiple accept="image/*" class="form-control" required>
                            <br>
...
function validateForm() {
    var input = document.getElementById('fotos_peritaje_transportes');
