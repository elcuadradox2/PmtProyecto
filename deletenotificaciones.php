...
$query = $db->prepare("SELECT ubicacion_notificacion FROM notificaciones WHERE id= :post_id");
...
$result = $db->prepare("SELECT foto FROM fotos_notificaciones WHERE ubicaciones_notificaciones= :ubicacion_notificacion");
...
$result = $db->prepare("DELETE FROM fotos_notificaciones WHERE ubicaciones_notificaciones= :ubicacion_notificacion");
$result->bindParam(':ubicacion_notificacion', $ubicacion_notificacion);
if(!$result->execute()){    
