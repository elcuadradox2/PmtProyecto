            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Listado Boleta Bitacora Operativos</h4>
                                <p class="category">Aqui esta el listado de todas las boletas bitacora operativos</p>
                             </div>
      ...
      if (td.innerHTML.toUpperCase().indexOf(filter) > -1) {
        ...
        tr[i].style.display = "none";
                                ...
                                <table class="table table-hover table-striped" id="myTable">
                                    ...
                                    <tbody>
									<?php 
	$result = $db->prepare("SELECT * FROM bitacora_operativos ORDER BY id DESC");
	$result->execute();
