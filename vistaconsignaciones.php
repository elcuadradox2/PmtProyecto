            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="content table-responsive table-full-width">	
                        ...
                        <input type="text" name="filter" value="" id="myInput" placeholder="Busqueda por Ubicacion" onkeyup="myFunction()"/>
                        <script>
                            function myFunction() {
                                // Declare variables
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="editaconsignaciones.php?id=<?php echo htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8'); ?>" class="fa fa-edit fa-lg text-warning"></a>
                                        <a href="deleteconsignaciones.php?id=<?php echo htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8'); ?>" title="Click para eliminar la boleta consignaciones" onclick="return confirm('¿Está seguro de que desea eliminar esta boleta?');"><i class="fa fa-trash fa-lg text-danger"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
