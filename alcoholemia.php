            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        ...
                        ?>
                        <form action="boletaalcoholemia.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            ...
                            <label for="fotos_alcoholemia">Ingrese Fotos Alcoholemia (Máximo 10 fotos)</label>
                            <input type="file" name="fotos_alcoholemia[]" id="fotos_alcoholemia" multiple accept="image/*" class="form-control" required>
                            <br>
...
function validateForm() {
    var input = document.getElementById('fotos_alcoholemia');
