            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        ...
                        $query = "SELECT no_boleta FROM agresiones ORDER BY id DESC LIMIT 1";
                        ...
                        <form action="boletaagresiones.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            ...
                            <label for="fotos_agresiones">Ingrese Fotos Agresiones (Maximo solo 10 fotos) </label>
                            <input type="file" name="fotos_agresiones[]" id="fotos_agresiones" multiple accept="image/*" class="form-control" required>
                            <br>
...
function validateForm() {
    var input = document.getElementById('fotos_agresiones');
