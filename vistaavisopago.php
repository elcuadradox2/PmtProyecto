                    ...
                    <div class="col-md-18">
                        <div class="card">
                            <div class="header">
                             ...
                             <label for="filter">Busqueda</label> <input type="text" name="filter" value="" id="myInput" placeholder="Busqueda por DPI" onkeyup="myFunction()"/>
...
?>
                                        ...
                                        <td><a href="deleteavisopago.php?id=<?php echo htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8'); ?>" title="Click para eliminar la boleta agresiones"><i class="fa fa-trash fa-lg text-danger"></i></a></td>
                                        </tr>
    <?php } ?>
                                    </tbody>
                                    </table>						
